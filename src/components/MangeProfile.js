...
class ManageProfile extends Component {
  ...
  render() {
    ...
    if(this.props.newAddress.length !==0) {
    ...
    if (cookie.get("idLogin") !== undefined) {
          ...
          {/* <Row form>
            ...
            <Col md={6}> */}
              <FormGroup>
                ...
                />
                 <Button className='button-danger' onClick={this.onSaveEditUser}>Save</Button>
              </FormGroup>
            {/* </Col>
          </Row> */}
          {/* <Row form>
      ...
      <div className="container  bg-transparent text-dark manageprofile rounded col-5">
        ...
        <Form>
          ...
          <br />
          <Button onClick={this.onSaveEditAddress}>Edit</Button>
